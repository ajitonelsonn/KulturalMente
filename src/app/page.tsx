...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative z-10 py-20 bg-red-900/20 backdrop-blur-sm border-y border-red-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-5xl font-bold text-white">The Problem</h3>
            </div>
            <p className="text-2xl text-red-100 max-w-4xl mx-auto leading-relaxed font-light">
              We live in a world of scattered cultural preferences with no way
              to understand deeper connections
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: Music,
                title: "Disconnected Preferences",
                description:
                  "Spotify knows your songs, Netflix knows your shows, but nothing connects these cultural dots to reveal your authentic identity.",
                examples: [
                  "Isolated music history",
                  "Separate movie preferences",
                  "Unconnected food choices",
                ],
              },
              {
                icon: Lightbulb,
                title: "No Deeper Understanding",
                description:
                  "We know WHAT we like, but never WHY we like it or what these preferences reveal about who we truly are.",
                examples: [
              ...
              },
              {
                ...
                description:
                  "Without understanding our cultural DNA, we miss amazing discoveries and growth opportunities that align with our authentic selves.",
                examples: [
                  "Missed cultural experiences",
                  "Generic recommendations",
                  "No personal growth guidance",
                ],
              },
            ].map((problem, index) => (
              <motion.div
                ...
                className="bg-red-900/20 backdrop-blur-sm rounded-2xl p-8 border border-red-500/20"
              >
                ...
                <ul className="space-y-2">
                  {problem.examples.map((example, i) => (
                    <li
                      key={i}
                      className="flex items-center text-red-200 text-sm"
                    >
          ...
          >
            <div className="bg-red-900/30 rounded-2xl p-8 border border-red-500/30 max-w-4xl mx-auto">
              <h4 className="text-3xl font-bold text-white mb-4">
                What connects your music, movies, food choices?
              </h4>
              <p className="text-xl text-red-100 leading-relaxed">
                What story do they tell about who you are? Until now, there was
                no way to find out...
              </p>
            </div>
          </motion.div>
      ...
      {/* Solution Section */}
      <section className="relative z-10 py-20 bg-green-900/20 backdrop-blur-sm border-y border-green-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <Award className="w-12 h-12 text-green-400 mr-4" />
              <h3 className="text-5xl font-bold text-white">The Solution</h3>
            </div>
            <p className="text-2xl text-green-100 max-w-4xl mx-auto leading-relaxed font-light">
              KulturalMente: AI-powered cultural intelligence built for the Qloo
              LLM Hackathon
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="bg-green-900/20 backdrop-blur-sm rounded-3xl p-12 border border-green-500/20 max-w-6xl mx-auto"
          >
            <div className="text-center mb-12">
              <h4 className="text-4xl font-bold text-white mb-6">
                🚀 The Innovation: Qloo's API + Advanced LLMs = Cultural DNA
                Discovery
              </h4>
              <p className="text-xl text-green-100 leading-relaxed">
                We combine Qloo's unparalleled cultural intelligence with
                advanced language models to transform scattered preferences into
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                ...
                <ul className="space-y-3 text-green-100">
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-400 rounded-full mr-3 mt-2" />
                    Cross-domain cultural connections
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-400 rounded-full mr-3 mt-2" />
                    10M+ cultural data points
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-400 rounded-full mr-3 mt-2" />
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl p-8 border border-white/20">
                <h5 className="text-3xl font-bold text-white mb-4">
                  ✨ The Unique Value: Neither technology alone could achieve
                  this
                </h5>
                <p className="text-xl text-white/80 leading-relaxed">
                  By combining Qloo's cross-domain insights with LLM
                  storytelling capabilities, we create something entirely new:
